...
def main():
    ...
    torch.save(model.state_dict(), "toggle_hetero_model.pt")
    print("Model saved")

    # =========================================================
    # RTL → Gate INFERENCE (CORE RESEARCH PART)
    # =========================================================
    ...
    if rtl_data is None or gate_data is None:
    ...
    with torch.no_grad():
        ...
        # Evaluate ONLY internal nets
        is_pi = ~gate_data["net"].train_mask
        internal_mask = ~is_pi
        ...
        # Plot
        # -----------------------------
        plot_file = "predicted_vs_true_hetero.png"
